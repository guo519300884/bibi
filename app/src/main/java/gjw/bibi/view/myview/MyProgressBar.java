...
public class MyProgressBar extends View {
    ...
    public MyProgressBar(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            progressWidth = array.getDimension(R.styleable.progress_progressWidth, DensityUtil.dip2px(context, 8));
            textSize = array.getDimension(R.styleable.progress_textSize, DensityUtil.dip2px(context, 16));
            array.recycle();
        } else {
            bgColor = Color.GRAY;
            srcColor = Color.RED;
            ...
            sweepArc = 0;
            progressWidth = DensityUtil.dip2px(context, 8);
