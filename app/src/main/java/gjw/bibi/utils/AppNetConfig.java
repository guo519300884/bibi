...
public class AppNetConfig {
    ...
    //追番页
    public static final String TO_THEM = "common?_device=android&appkey=1d8b6e7d45233436&build=501000&mobi_app=android&platform=android&scale=hdpi&ts=1490013188000&sign=92541a11ed62841120e786e637b9db3b";
    //分区页
    public static final String ZONE = "http://app.bilibili.com/x/v2/show/region?appkey=1d8b6e7d45233436&build=501000&mobi_app=android&platform=android&ts=1490016011000&sign=8488f28be76d834c1963dedd5fb42a26";
    //发现页
